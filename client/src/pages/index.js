    ...
    <Layout>
      ...
      <div>
        ...
        `}>
          ...
          <hr/>
          <p><strong>Holm School</strong> is an <a href={`https://github.com/HolmSchool/holm-school`}>open source repo</a> collating hundreds of free college textbooks and lectures for you to use in your self-educational odyssey. Whether that be <Link to={`/syllabi/computer-science`}>learning how to code</Link>, <Link to={`/syllabi/art-history`}>the basics of art history</Link>, <Link to={`/syllabi/hum110`}>years worth of "Great Books"/Humanities reading lists</Link>, <Link to={`/z-degrees`}>or many other academic subjects we group under the banner of "Z-Degrees"</Link>, you'll most likely find something of value -- and at not cost to you! We do this as a means of promoting "<Link to={`/syllabi/computer-science/#holmschooling`}>unschooling</Link>," or more specifically in our case: "holmschooling."</p>
          <hr/>
